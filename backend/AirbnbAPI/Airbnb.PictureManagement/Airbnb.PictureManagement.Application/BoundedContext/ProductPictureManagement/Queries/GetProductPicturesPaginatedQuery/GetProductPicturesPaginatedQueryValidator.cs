...
public class GetProductPicturesPaginatedQueryValidator : AbstractValidator<GetProductPicturesPaginatedQuery>
{
    public GetProductPicturesPaginatedQueryValidator()
    {
        RuleFor(q => q.Page)
