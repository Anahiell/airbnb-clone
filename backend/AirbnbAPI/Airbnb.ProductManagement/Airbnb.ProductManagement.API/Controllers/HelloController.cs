...
namespace AirbnbAPI.Controllers
{
    ...
    public class HelloController(ProductRepository propertyEntityRepository) : ControllerBase
    {
        [HttpGet]
        [Route("/GetHello")]
        ...
        {
            var properties = await propertyEntityRepository.GetAllProductsAsync();
